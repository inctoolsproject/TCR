...
Idline: http://line.me/ti/p/boy29putra""",
    "lang":"JP",
    "comment":"👉ąµţ๏ℓɨЌ€ B by »»» http://line.me/ti/p/boy29putra «««",
    "commentOn":False,
    "commentBlack":{},
    "wblack":False,
    "dblack":False,
                    ...
                    if msg.to in wait2['readPoint']:
                        if wait2["ROM"][msg.to].items() == []:
                            ...
                            for rom in wait2["ROM"][msg.to].items():
                                print "[Command] Check"
                                chiya += rom[1] + "\n"
                        cl.sendText(msg.to, "✔ ✰ tɛǟʍ ɮօt killers ✰\nRead : %s\n\n✖ Sider :\n%s\nPoint creation date n time:\n[%s]"  % (wait2['readMember'][msg.to],chiya,setTime[msg.to]))
                        try:
                            del wait2['readPoint'][msg.to]
                            del wait2['readMember'][msg.to]
                        except:
...
#-----------------------------------------------
         #----------------Fungsi Join Group Start-----------------------#
            elif msg.text in ["One piece","Masuk"]: #Panggil Semua Bot
              if msg.from_ in owner:
    ...
    #-------------Fungsi Leave Group Start---------------#
            elif msg.text in ["Kabur all","Bye all"]: #Bot Ninggalin Group termasuk Bot Induk
              if msg.from_ in owner:
                if msg.toType == 2:
                    ginfo = cl.getGroup(msg.to)
                    try:
    ...
    #-------------Fungsi Tag All Finish---------------#
        ...
        #----------------Fungsi Banned Kick Target Finish----------------------#                
            ...
            elif ["Ready op","Jitak"] in msg.text:
              if msg.from_ in owner:
                if msg.toType == 2:
                    print "ok"
