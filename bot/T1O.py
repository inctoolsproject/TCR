...
cl = LINETCR.LINE()#1 
#cl.login(qr=True)
cl.login(token="EnwF4R82LfwwGGw55PO8.88+nDjQxuv+ILAT7GhIJ/a.drFpeF3SSeyrtbFDE7H8Rk6G8SkVYJCNn0F8gC8RnWg=")
cl.loginResult()

ki = LINETCR.LINE()#2
#ki.login(qr=True)
ki.login(token="EnZArmIVumAXKwzsikdd.60Qyb8mOuAVgV5Vdh4D+lq.i1M3AEbURty9Vp8wOSLc6daHfKAg2VFRu8WI0gb9e9Y=")
ki.loginResult()

kk = LINETCR.LINE()#3
#kk.login(qr=True)
kk.login(token="EnG9CmlUb9JwS8CkT6X9.h+VgDuxKoaZ/Ix15FdymMq.PAv2VaTYika0RT2x/NxdZuSDv918Bv3JEnVv35M2RyE=")
kk.loginResult()

kc = LINETCR.LINE()#4
#kc.login(qr=True)
kc.login(token="EnVNO59XJ7VktGcfGk1b.fMqbw7X3LQ8eNUdI+8MrUW.eB0Lhc+xOuXi1IwdK6VEKBFHWVu9qpVX3FMg+bVuV3U=")
kc.loginResult()

ks = LINETCR.LINE()#5
#ks.login(qr=True)
ks.login(token="Endm03owJMYnMvr2MxB1.kBE/NFkWPSELzSoewgXD8q.nG5IFETXWQxevWBvQvf9AJnBwQ+lMM8Y3uW49HIRn7E=")
ks.loginResult()

k1 = LINETCR.LINE()#6
#k1.login(qr=True)
k1.login(token="EnP2HF9VXjPLHCEeeLCa.4ZFAXZuTsTpRvyAS5k8H2G.wFWx563CLlqV42IqNVB9YF776pacRlVrqGjQDWyZ2+4=")
k1.loginResult()

k2 = LINETCR.LINE()#7
#k2.login(qr=True)
k2.login(token="EnYP361RTlPsIIFsLdj6.IBBodWiApDp/EOEOhJb8jG.75OQYRKjRl3JAbscE2o0rPhidIPD5OtFN6Z5IYxw/m8=")
k2.loginResult()

k3 = LINETCR.LINE()#8 
#k3.login(qr=True)
k3.login(token="EnRVtweYVA3sTfpoqJL4.pDxKxSDhBDQ9GRkpz3uq9a.dm4JT9UMEuoJ9MYw74N46P+2Nq0gSOi2Sd3zSCepEP0=")
k3.loginResult()

k4 = LINETCR.LINE()#9
#k4.login(qr=True)
k4.login(token="En3wz2M8745iw1cFdTAb.S1ZLOvAig2mP47vIv65QAW.5j+7vz9liCsR5WLmtnwhNv/H6W92vrkmYtkKSQ6Ai7k=")
k4.loginResult()

k5 = LINETCR.LINE()#10
#k5.login(qr=True)
k5.login(token="Enryzj3UKarUoJIkqd2e.NAnZZf1S7EvtLnPnRb3a3G.eNmOdPGvTHPHdHqys+N9p3QzejANK0+7Hg7wZpYFaJw=")
k5.loginResult()
...
induk=[mid]
Creator=[""]
admin=["mid,Amid,Bmid,Cmid,Dmid,Emid,Fmid,Gmid,Hmid,Imid"]
owner=[""]
wait = {
    'contact':False,
    'autoJoin':True,
